namespace TeknoparrotAutoXinput
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			grp_gunB_gun4irOptions = new GroupBox();
			chk_gunB_domagerumble = new Krypton.Toolkit.KryptonCheckBox();
			chk_gunB_4tiers = new Krypton.Toolkit.KryptonCheckBox();
			chk_gunB_AutoJoy = new Krypton.Toolkit.KryptonCheckBox();
			...
			grp_gunA_gun4irOptions = new GroupBox();
			chk_gunA_domagerumble = new Krypton.Toolkit.KryptonCheckBox();
			chk_gunA_4tiers = new Krypton.Toolkit.KryptonCheckBox();
			chk_gunA_AutoJoy = new Krypton.Toolkit.KryptonCheckBox();
			cmb_gunA_com = new Krypton.Toolkit.KryptonComboBox();
			kryptonLabel34 = new Krypton.Toolkit.KryptonLabel();
			chk_gunA_Crosshair = new Krypton.Toolkit.KryptonCheckBox();
			...
			kryptonLabel77 = new Krypton.Toolkit.KryptonLabel();
			...
			chk_patchResolutionTP = new Krypton.Toolkit.KryptonCheckBox();
			chk_patchResolutionFix = new Krypton.Toolkit.KryptonCheckBox();
			kryptonLabel71 = new Krypton.Toolkit.KryptonLabel();
			chk_patchGpuTP = new Krypton.Toolkit.KryptonCheckBox();
			cmb_displayMode = new Krypton.Toolkit.KryptonComboBox();
			chk_patchFFB = new Krypton.Toolkit.KryptonCheckBox();
			chk_patchOthersGameOptions = new Krypton.Toolkit.KryptonCheckBox();
			chk_patchOthersTPSettings = new Krypton.Toolkit.KryptonCheckBox();
			...
			chk_patchGameID = new Krypton.Toolkit.KryptonCheckBox();
			...
			((System.ComponentModel.ISupportInitialize)cmb_gunB_com).BeginInit();
			grp_gunB_sindenOptions.SuspendLayout();
			...
			grp_gunA_sindenOptions.SuspendLayout();
			grp_gunA_gun4irOptions.SuspendLayout();
			...
			// chk_showStartup
			// 
			chk_showStartup.Location = new Point(9, 25);
			...
			// chk_FFB
			// 
			chk_FFB.Location = new Point(9, 51);
			...
			btn_testxinput.Size = new Size(101, 180);
			...
			txt_xinputdata.Size = new Size(648, 184);
			...
			groupBox4.Location = new Point(13, 2);
			...
			groupBox7.Location = new Point(13, 61);
			...
			groupBox8.Location = new Point(13, 170);
			...
			groupBox9.Size = new Size(775, 215);
			...
			kryptonLabel28.Values.Text = "Select Vjoy to use :";
			// 
			// cmb_vjoy
			// 
			...
			groupBox12.Controls.Add(kryptonLabel46);
			groupBox12.Controls.Add(chk_gunB_OffscreenReload);
			groupBox12.Controls.Add(kryptonLabel35);
			groupBox12.Controls.Add(kryptonLabel44);
			groupBox12.Controls.Add(chk_gunB_Vjoy);
			groupBox12.Controls.Add(grp_gunB_gun4irOptions);
			groupBox12.Controls.Add(grp_gunB_sindenOptions);
			groupBox12.Controls.Add(chk_gunB_Crosshair);
			groupBox12.Controls.Add(kryptonLabel36);
			...
			kryptonLabel35.Size = new Size(67, 20);
			kryptonLabel35.TabIndex = 79;
			kryptonLabel35.Values.Text = "Crosshair :";
			// 
			// kryptonLabel44
			// 
			kryptonLabel44.Location = new Point(0, 76);
			kryptonLabel44.Name = "kryptonLabel44";
			kryptonLabel44.Size = new Size(40, 20);
			kryptonLabel44.TabIndex = 78;
			kryptonLabel44.Values.Text = "Vjoy :";
			// 
			// chk_gunB_Vjoy
			// 
			...
			// 
			grp_gunB_gun4irOptions.Controls.Add(chk_gunB_domagerumble);
			grp_gunB_gun4irOptions.Controls.Add(chk_gunB_4tiers);
			grp_gunB_gun4irOptions.Controls.Add(chk_gunB_AutoJoy);
			grp_gunB_gun4irOptions.Controls.Add(kryptonLabel43);
			grp_gunB_gun4irOptions.Controls.Add(cmb_gunB_com);
			grp_gunB_gun4irOptions.Location = new Point(8, 162);
			grp_gunB_gun4irOptions.Name = "grp_gunB_gun4irOptions";
			grp_gunB_gun4irOptions.Size = new Size(356, 67);
			grp_gunB_gun4irOptions.TabIndex = 75;
			grp_gunB_gun4irOptions.TabStop = false;
			grp_gunB_gun4irOptions.Text = "Gun4Ir Specific options";
			// 
			...
			chk_gunB_domagerumble.Values.Text = "Damage = Rumble";
			// 
			// chk_gunB_4tiers
			// 
			...
			// kryptonLabel43
			// 
			kryptonLabel43.Location = new Point(8, 20);
			kryptonLabel43.Name = "kryptonLabel43";
			kryptonLabel43.Size = new Size(68, 20);
			kryptonLabel43.TabIndex = 50;
			kryptonLabel43.Values.Text = "Com Port :";
			// 
			// cmb_gunB_com
			// 
			cmb_gunB_com.DropDownStyle = ComboBoxStyle.DropDownList;
			cmb_gunB_com.DropDownWidth = 150;
			cmb_gunB_com.IntegralHeight = false;
			cmb_gunB_com.Items.AddRange(new object[] { "<none>", "gamepad", "sinden", "guncon1", "guncon2", "wiimote" });
			cmb_gunB_com.Location = new Point(104, 18);
			cmb_gunB_com.Name = "cmb_gunB_com";
			cmb_gunB_com.Size = new Size(138, 21);
			cmb_gunB_com.StateCommon.ComboBox.Content.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			cmb_gunB_com.TabIndex = 53;
			// 
			...
			// 
			radio_gunB_sindenPump1.Location = new Point(105, 22);
			radio_gunB_sindenPump1.Name = "radio_gunB_sindenPump1";
			radio_gunB_sindenPump1.Size = new Size(60, 20);
			...
			radio_gunB_sindenPump2.Name = "radio_gunB_sindenPump2";
			...
			// 
			radio_gunB_sindenPump3.Location = new Point(105, 44);
			radio_gunB_sindenPump3.Name = "radio_gunB_sindenPump3";
			radio_gunB_sindenPump3.Size = new Size(218, 20);
			...
			// chk_gunB_Crosshair
			// 
			chk_gunB_Crosshair.Location = new Point(112, 101);
			chk_gunB_Crosshair.Name = "chk_gunB_Crosshair";
			chk_gunB_Crosshair.Size = new Size(107, 20);
			chk_gunB_Crosshair.TabIndex = 71;
			chk_gunB_Crosshair.Values.Text = "Show Crosshair";
			// 
			// kryptonLabel36
			// 
			kryptonLabel36.Location = new Point(0, 48);
			kryptonLabel36.Name = "kryptonLabel36";
			kryptonLabel36.Size = new Size(79, 20);
			kryptonLabel36.TabIndex = 56;
			kryptonLabel36.Values.Text = "Recoil Type :";
			// 
			// cmb_gunB_recoil
			// 
			...
			cmb_gunB_recoil.TabIndex = 55;
			cmb_gunB_recoil.SelectedIndexChanged += cmb_gunB_recoil_SelectedIndexChanged;
			// 
			// btn_gunB_configure
			// 
			btn_gunB_configure.Location = new Point(255, 20);
			btn_gunB_configure.Name = "btn_gunB_configure";
			btn_gunB_configure.Size = new Size(113, 23);
			...
			cmb_gunB_type.Items.AddRange(new object[] { "<none>", "gamepad", "sinden", "guncon1", "guncon2", "wiimote" });
			cmb_gunB_type.Location = new Point(112, 20);
			cmb_gunB_type.Name = "cmb_gunB_type";
			cmb_gunB_type.Size = new Size(138, 21);
			...
			// kryptonLabel27
			// 
			kryptonLabel27.Location = new Point(0, 21);
			...
			groupBox11.Controls.Add(kryptonLabel45);
			groupBox11.Controls.Add(chk_gunA_OffscreenReload);
			groupBox11.Controls.Add(chk_reversePedal);
			groupBox11.Controls.Add(kryptonLabel42);
			groupBox11.Controls.Add(kryptonLabel41);
			groupBox11.Controls.Add(chk_gunA_Vjoy);
			groupBox11.Controls.Add(grp_gunA_sindenOptions);
			groupBox11.Controls.Add(grp_gunA_gun4irOptions);
			groupBox11.Controls.Add(chk_gunA_Crosshair);
			groupBox11.Controls.Add(kryptonLabel37);
			...
			chk_reversePedal.Values.Text = "... And on P1 force the main pedal to the left side";
			chk_reversePedal.CheckedChanged += chk_reversePedal_CheckedChanged;
			// 
			// kryptonLabel42
			// 
			kryptonLabel42.Location = new Point(0, 102);
			kryptonLabel42.Name = "kryptonLabel42";
			kryptonLabel42.Size = new Size(67, 20);
			kryptonLabel42.TabIndex = 76;
			kryptonLabel42.Values.Text = "Crosshair :";
			// 
			// kryptonLabel41
			// 
			kryptonLabel41.Location = new Point(0, 76);
			kryptonLabel41.Name = "kryptonLabel41";
			kryptonLabel41.Size = new Size(40, 20);
			kryptonLabel41.TabIndex = 75;
			kryptonLabel41.Values.Text = "Vjoy :";
			// 
			// chk_gunA_Vjoy
			// 
			...
			// 
			radio_gunA_sindenPump1.Location = new Point(100, 22);
			radio_gunA_sindenPump1.Name = "radio_gunA_sindenPump1";
			radio_gunA_sindenPump1.Size = new Size(60, 20);
			radio_gunA_sindenPump1.TabIndex = 60;
			radio_gunA_sindenPump1.Values.Text = "Reload";
			// 
			// radio_gunA_sindenPump2
			// 
			radio_gunA_sindenPump2.Location = new Point(167, 22);
			radio_gunA_sindenPump2.Name = "radio_gunA_sindenPump2";
			radio_gunA_sindenPump2.Size = new Size(58, 20);
			radio_gunA_sindenPump2.TabIndex = 61;
			radio_gunA_sindenPump2.Values.Text = "Action";
			// 
			// radio_gunA_sindenPump3
			// 
			radio_gunA_sindenPump3.Location = new Point(100, 44);
			radio_gunA_sindenPump3.Name = "radio_gunA_sindenPump3";
			radio_gunA_sindenPump3.Size = new Size(218, 20);
			radio_gunA_sindenPump3.TabIndex = 62;
			radio_gunA_sindenPump3.Values.Text = "Action if Reload Offscreen availiable";
			// 
			// kryptonLabel29
			// 
			kryptonLabel29.Location = new Point(2, 22);
			...
			// 
			// grp_gunA_gun4irOptions
			// 
			grp_gunA_gun4irOptions.Controls.Add(chk_gunA_domagerumble);
			grp_gunA_gun4irOptions.Controls.Add(chk_gunA_4tiers);
			grp_gunA_gun4irOptions.Controls.Add(chk_gunA_AutoJoy);
			grp_gunA_gun4irOptions.Controls.Add(cmb_gunA_com);
			grp_gunA_gun4irOptions.Controls.Add(kryptonLabel34);
			grp_gunA_gun4irOptions.Location = new Point(9, 162);
			grp_gunA_gun4irOptions.Name = "grp_gunA_gun4irOptions";
			grp_gunA_gun4irOptions.Size = new Size(357, 67);
			grp_gunA_gun4irOptions.TabIndex = 72;
			grp_gunA_gun4irOptions.TabStop = false;
			grp_gunA_gun4irOptions.Text = "Gun4Ir Specific options";
			// 
			...
			chk_gunA_domagerumble.Values.Text = "Damage = Rumble";
			// 
			// chk_gunA_4tiers
			// 
			...
			chk_gunA_AutoJoy.CheckedChanged += chk_gunA_AutoJoy_CheckedChanged;
			// 
			// cmb_gunA_com
			// 
			cmb_gunA_com.DropDownStyle = ComboBoxStyle.DropDownList;
			cmb_gunA_com.DropDownWidth = 150;
			cmb_gunA_com.IntegralHeight = false;
			cmb_gunA_com.Items.AddRange(new object[] { "<none>", "gamepad", "sinden", "guncon1", "guncon2", "wiimote" });
			cmb_gunA_com.Location = new Point(100, 19);
			cmb_gunA_com.Name = "cmb_gunA_com";
			cmb_gunA_com.Size = new Size(138, 21);
			cmb_gunA_com.StateCommon.ComboBox.Content.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			cmb_gunA_com.TabIndex = 49;
			// 
			// kryptonLabel34
			// 
			kryptonLabel34.Location = new Point(8, 20);
			kryptonLabel34.Name = "kryptonLabel34";
			kryptonLabel34.Size = new Size(68, 20);
			kryptonLabel34.TabIndex = 50;
			kryptonLabel34.Values.Text = "Com Port :";
			// 
			// chk_gunA_Crosshair
			// 
			chk_gunA_Crosshair.Location = new Point(110, 101);
			chk_gunA_Crosshair.Name = "chk_gunA_Crosshair";
			chk_gunA_Crosshair.Size = new Size(107, 20);
			chk_gunA_Crosshair.TabIndex = 70;
			chk_gunA_Crosshair.Values.Text = "Show Crosshair";
			chk_gunA_Crosshair.CheckedChanged += chk_gunA_Crosshair_CheckedChanged;
			// 
			// kryptonLabel37
			// 
			kryptonLabel37.Location = new Point(0, 48);
			kryptonLabel37.Name = "kryptonLabel37";
			kryptonLabel37.Size = new Size(79, 20);
			kryptonLabel37.TabIndex = 58;
			kryptonLabel37.Values.Text = "Recoil Type :";
			// 
			// cmb_gunA_recoil
			// 
			...
			cmb_gunA_recoil.TabIndex = 57;
			cmb_gunA_recoil.SelectedIndexChanged += cmb_gunA_recoil_SelectedIndexChanged;
			// 
			// btn_gunA_configure
			// 
			btn_gunA_configure.Location = new Point(253, 20);
			btn_gunA_configure.Name = "btn_gunA_configure";
			btn_gunA_configure.Size = new Size(113, 23);
			...
			// kryptonLabel26
			// 
			kryptonLabel26.Location = new Point(0, 23);
			...
			cmb_gunA_type.Items.AddRange(new object[] { "<none>", "gamepad", "sinden", "guncon1", "guncon2", "wiimote" });
			cmb_gunA_type.Location = new Point(109, 20);
			cmb_gunA_type.Name = "cmb_gunA_type";
			cmb_gunA_type.Size = new Size(138, 21);
			...
			// button1
			// 
			button1.Location = new Point(602, 125);
			...
			// kryptonLabel40
			// 
			kryptonLabel40.Location = new Point(18, 102);
			kryptonLabel40.Name = "kryptonLabel40";
			kryptonLabel40.Size = new Size(449, 20);
			kryptonLabel40.TabIndex = 79;
			kryptonLabel40.Values.Text = "(To Start/Kill Riva Tuner on game launch/exit. This Option must be set per game)";
			// 
			// btn_rivatuner
			// 
			btn_rivatuner.Location = new Point(482, 79);
			btn_rivatuner.Name = "btn_rivatuner";
			btn_rivatuner.Size = new Size(32, 23);
			btn_rivatuner.TabIndex = 78;
			btn_rivatuner.Values.Text = "...";
			btn_rivatuner.Click += btn_rivatuner_Click;
			// 
			// kryptonLabel39
			// 
			kryptonLabel39.Location = new Point(8, 82);
			kryptonLabel39.Name = "kryptonLabel39";
			kryptonLabel39.Size = new Size(125, 20);
			kryptonLabel39.TabIndex = 76;
			kryptonLabel39.Values.Text = "Riva Tuner Software :";
			// 
			// txt_rivatunersoft
			// 
			txt_rivatunersoft.Location = new Point(133, 79);
			txt_rivatunersoft.Name = "txt_rivatunersoft";
			txt_rivatunersoft.ReadOnly = true;
			...
			tabControl1.Controls.Add(tabPatch);
			...
			// tabGlobal
			// 
			tabGlobal.Controls.Add(groupBox14);
			...
			groupBox14.Location = new Point(13, 311);
			...
			kryptonLabel55.Values.Text = "Some Magpie settings for Lightgun can be set in the Lightgun Tab";
			// 
			// chk_magpieShowFps
			// 
			...
			chk_magpieShowFps.Values.Text = "Show Fps";
			// 
			...
			chk_magpieTripleBuffering.Values.Text = "Triple Buffering";
			// 
			// chk_magpieVsync
			// 
			...
			chk_magpieVsync.Values.Text = "Vsync";
			// 
			// kryptonLabel52
			// 
			kryptonLabel52.Location = new Point(707, 71);
			...
			kryptonLabel49.Size = new Size(93, 20);
			...
			// kryptonLabel47
			// 
			kryptonLabel47.Location = new Point(457, 18);
			...
			// num_magpieDelay
			// 
			num_magpieDelay.Increment = new decimal(new int[] { 1, 0, 0, 0 });
			num_magpieDelay.Location = new Point(568, 68);
			num_magpieDelay.Maximum = new decimal(new int[] { 100, 0, 0, 0 });
			num_magpieDelay.Minimum = new decimal(new int[] { 0, 0, 0, 0 });
			num_magpieDelay.Name = "num_magpieDelay";
			num_magpieDelay.Size = new Size(126, 22);
			num_magpieDelay.TabIndex = 83;
			num_magpieDelay.Value = new decimal(new int[] { 3, 0, 0, 0 });
			// 
			// cmb_magpieCapture
			// 
			...
			cmb_magpieCapture.Items.AddRange(new object[] { "Graphics Capture", "Desktop Duplication", "GDI", "DwmSharedSurface" });
			cmb_magpieCapture.Location = new Point(568, 44);
			cmb_magpieCapture.Name = "cmb_magpieCapture";
			cmb_magpieCapture.Size = new Size(194, 21);
			...
			cmb_magpieScaling.Items.AddRange(new object[] { "Lanczos", "FSR", "FSRCNNX", "ACNet", "Anime4K", "CRT-Geom", "Integer Scale 2x" });
			cmb_magpieScaling.Location = new Point(568, 17);
			cmb_magpieScaling.Name = "cmb_magpieScaling";
			cmb_magpieScaling.Size = new Size(194, 21);
			...
			// chk_useMagpie
			// 
			chk_useMagpie.Location = new Point(6, 22);
			chk_useMagpie.Name = "chk_useMagpie";
			chk_useMagpie.Size = new Size(255, 20);
			chk_useMagpie.TabIndex = 1;
			chk_useMagpie.Values.Text = "Use Magpie for games in windowed Mode";
			// 
			// tabPatch
			// 
			...
			tabPatch.Controls.Add(kryptonLabel77);
			...
			tabPatch.Controls.Add(chk_patchResolutionTP);
			tabPatch.Controls.Add(chk_patchResolutionFix);
			tabPatch.Controls.Add(kryptonLabel71);
			tabPatch.Controls.Add(chk_patchGpuTP);
			tabPatch.Controls.Add(cmb_displayMode);
			tabPatch.Controls.Add(chk_patchFFB);
			tabPatch.Controls.Add(chk_patchOthersGameOptions);
			tabPatch.Controls.Add(chk_patchOthersTPSettings);
			tabPatch.Controls.Add(chk_patchReshade);
			tabPatch.Controls.Add(chk_patchGpuFix);
			...
			tabPatch.Controls.Add(cmb_gpu);
			tabPatch.Controls.Add(groupBox5);
			tabPatch.Controls.Add(groupBox6);
			...
			// kryptonLabel77
			// 
			kryptonLabel77.Location = new Point(13, 322);
			kryptonLabel77.Name = "kryptonLabel77";
			kryptonLabel77.Size = new Size(124, 20);
			kryptonLabel77.TabIndex = 175;
			kryptonLabel77.Values.Text = "Performance profile :";
			// 
			// cmb_performance
			// 
			...
			cmb_performance.Location = new Point(140, 320);
			...
			groupBox17.Location = new Point(18, 650);
			groupBox17.Name = "groupBox17";
			groupBox17.Size = new Size(770, 43);
			...
			// 
			chk_tplicence_unreg_onlaunch.Location = new Point(567, 9);
			...
			// 
			chk_tplicence_unreg_onexit.Location = new Point(567, 25);
			...
			// kryptonLabel51
			// 
			kryptonLabel51.Location = new Point(8, 19);
			...
			// txt_tplicence
			// 
			txt_tplicence.Location = new Point(81, 16);
			txt_tplicence.Name = "txt_tplicence";
			txt_tplicence.PasswordChar = '*';
			txt_tplicence.Size = new Size(233, 23);
			txt_tplicence.TabIndex = 164;
			// 
			// btn_tplicence_show
			// 
			btn_tplicence_show.Location = new Point(320, 16);
			...
			// 
			chk_tplicence_onstart.Location = new Point(396, 16);
			...
			// 
			chk_patchDisplayModeTP.Location = new Point(568, 294);
			...
			chk_patchDisplayModeTP.Values.Text = "Force fix from TP Settings";
			chk_patchDisplayModeTP.CheckedChanged += chk_patchDisplayModeTP_CheckedChanged;
			// 
			// chk_patchDisplayModeFix
			// 
			chk_patchDisplayModeFix.Location = new Point(373, 295);
			...
			chk_patchDisplayModeFix.Values.Text = "Use fix from patch folder";
			// 
			// kryptonLabel72
			// 
			kryptonLabel72.Location = new Point(15, 294);
			kryptonLabel72.Name = "kryptonLabel72";
			kryptonLabel72.Size = new Size(91, 20);
			kryptonLabel72.TabIndex = 160;
			kryptonLabel72.Values.Text = "Display Mode :";
			// 
			// chk_patchResolutionTP
			// 
			chk_patchResolutionTP.Location = new Point(568, 265);
			...
			chk_patchResolutionTP.Values.Text = "Force fix from TP Settings";
			chk_patchResolutionTP.CheckedChanged += chk_patchResolutionTP_CheckedChanged;
			// 
			// chk_patchResolutionFix
			// 
			chk_patchResolutionFix.Location = new Point(373, 266);
			...
			// kryptonLabel71
			// 
			kryptonLabel71.Location = new Point(21, 213);
			kryptonLabel71.Name = "kryptonLabel71";
			kryptonLabel71.Size = new Size(107, 20);
			kryptonLabel71.TabIndex = 157;
			kryptonLabel71.Values.Text = "Overide Settings :";
			// 
			// chk_patchGpuTP
			// 
			chk_patchGpuTP.Location = new Point(568, 239);
			chk_patchGpuTP.Name = "chk_patchGpuTP";
			chk_patchGpuTP.Size = new Size(163, 20);
			chk_patchGpuTP.TabIndex = 156;
			chk_patchGpuTP.Values.Text = "Force fix from TP Settings";
			chk_patchGpuTP.CheckedChanged += kryptonCheckBox1_CheckedChanged;
			// 
			// cmb_displayMode
			// 
			cmb_displayMode.AutoCompleteCustomSource.AddRange(new string[] { "Use Recommanded settings", "Force Fullscreen", "Force Windowed", "Don't alter settings" });
			...
			cmb_displayMode.Location = new Point(139, 293);
			...
			cmb_displayMode.SelectedIndexChanged += cmb_patchGpuTP_SelectedIndexChanged;
			// 
			// chk_patchFFB
			// 
			...
			// 
			chk_patchOthersGameOptions.Location = new Point(138, 212);
			...
			chk_patchOthersGameOptions.Values.Text = "Override GameOptions settings if necommanded";
			chk_patchOthersGameOptions.CheckedChanged += chk_patchOthersGameOptions_CheckedChanged;
			// 
			// chk_patchOthersTPSettings
			// 
			chk_patchOthersTPSettings.Location = new Point(441, 212);
			...
			chk_patchOthersTPSettings.Values.Text = "Overwrite TP settings if necommanded";
			// 
			// chk_patchReshade
			// 
			chk_patchReshade.Location = new Point(139, 342);
			...
			// txt_customName
			// 
			txt_customName.Location = new Point(132, 82);
			...
			// lbl_apm3id
			// 
			lbl_apm3id.Location = new Point(8, 27);
			...
			// kryptonLabel66
			// 
			kryptonLabel66.Location = new Point(8, 85);
			...
			// chk_patchGameID
			// 
			chk_patchGameID.Location = new Point(456, -2);
			chk_patchGameID.Name = "chk_patchGameID";
			chk_patchGameID.Size = new Size(216, 20);
			chk_patchGameID.TabIndex = 148;
			chk_patchGameID.Values.Text = "Overwrite ids / Name settings in TP";
			// 
			// kryptonLabel67
			// 
			kryptonLabel67.Location = new Point(8, 56);
			...
			groupBox15.Location = new Point(21, 552);
			...
			// kryptonLabel60
			// 
			kryptonLabel60.Location = new Point(18, 265);
			...
			kryptonLabel60.Click += kryptonLabel60_Click;
			// 
			// cmb_resolution
			// 
			...
			cmb_resolution.Location = new Point(139, 266);
			...
			cmb_gpu.Location = new Point(139, 238);
			...
			cmb_gpu.TabIndex = 99;
			cmb_gpu.SelectedIndexChanged += cmb_gpu_SelectedIndexChanged_1;
			// 
			// groupBox5
			// 
			...
			groupBox6.Size = new Size(770, 86);
			...
			// kryptonLabel19
			// 
			kryptonLabel19.Location = new Point(7, 62);
			...
			grp_gunB_gun4irOptions.ResumeLayout(false);
			grp_gunB_gun4irOptions.PerformLayout();
			((System.ComponentModel.ISupportInitialize)cmb_gunB_com).EndInit();
			grp_gunB_sindenOptions.ResumeLayout(false);
			grp_gunB_sindenOptions.PerformLayout();
			...
			grp_gunA_sindenOptions.ResumeLayout(false);
			grp_gunA_sindenOptions.PerformLayout();
			grp_gunA_gun4irOptions.ResumeLayout(false);
			grp_gunA_gun4irOptions.PerformLayout();
		...
		private Krypton.Toolkit.KryptonButton btn_selectSinden;
		private Krypton.Toolkit.KryptonLabel kryptonLabel32;
		private Krypton.Toolkit.KryptonTextBox txt_sindensoft;
		private Krypton.Toolkit.KryptonButton btn_mamehooker;
		private Krypton.Toolkit.KryptonLabel kryptonLabel31;
		private Krypton.Toolkit.KryptonTextBox txt_mamehookersoft;
		private Krypton.Toolkit.KryptonButton btn_demulshooter;
		private Krypton.Toolkit.KryptonLabel kryptonLabel30;
		private Krypton.Toolkit.KryptonTextBox txt_demulshootersoft;
		...
		private Krypton.Toolkit.KryptonComboBox cmb_gunA_com;
		private Krypton.Toolkit.KryptonCheckBox chk_gunA_Crosshair;
		private GroupBox groupBox12;
		private Krypton.Toolkit.KryptonLabel kryptonLabel36;
		private Krypton.Toolkit.KryptonComboBox cmb_gunB_recoil;
		private Krypton.Toolkit.KryptonComboBox cmb_gunB_com;
		...
		private Krypton.Toolkit.KryptonRadioButton radio_gunA_sindenPump3;
		private Krypton.Toolkit.KryptonRadioButton radio_gunA_sindenPump2;
		private Krypton.Toolkit.KryptonRadioButton radio_gunA_sindenPump1;
		private Krypton.Toolkit.KryptonLabel kryptonLabel38;
		private Krypton.Toolkit.KryptonRadioButton radio_gunB_sindenPump3;
		private Krypton.Toolkit.KryptonRadioButton radio_gunB_sindenPump2;
		private Krypton.Toolkit.KryptonRadioButton radio_gunB_sindenPump1;
		private Krypton.Toolkit.KryptonCheckBox chk_gunB_Crosshair;
		private Krypton.Toolkit.KryptonCheckBox chk_gunB_AutoJoy;
		private Krypton.Toolkit.KryptonCheckBox chk_gunA_AutoJoy;
		private Krypton.Toolkit.KryptonCheckBox chk_alwaysrunmamehooker;
		private GroupBox groupBox13;
		private Krypton.Toolkit.KryptonLabel kryptonLabel40;
		private Krypton.Toolkit.KryptonButton btn_rivatuner;
		private Krypton.Toolkit.KryptonLabel kryptonLabel39;
		private Krypton.Toolkit.KryptonTextBox txt_rivatunersoft;
		private GroupBox grp_gunA_gun4irOptions;
		private Krypton.Toolkit.KryptonCheckBox chk_gunA_4tiers;
		private GroupBox grp_gunA_sindenOptions;
		private Krypton.Toolkit.KryptonCheckBox chk_gunA_domagerumble;
		private Krypton.Toolkit.KryptonLabel kryptonLabel35;
		private Krypton.Toolkit.KryptonLabel kryptonLabel44;
		private Krypton.Toolkit.KryptonCheckBox chk_gunB_Vjoy;
		private GroupBox grp_gunB_gun4irOptions;
		private Krypton.Toolkit.KryptonCheckBox chk_gunB_domagerumble;
		private Krypton.Toolkit.KryptonCheckBox chk_gunB_4tiers;
		private Krypton.Toolkit.KryptonLabel kryptonLabel43;
		private GroupBox grp_gunB_sindenOptions;
		...
		private Krypton.Toolkit.KryptonCheckBox chk_useMagpie;
		private Krypton.Toolkit.KryptonComboBox cmb_magpieCapture;
		private Krypton.Toolkit.KryptonComboBox cmb_magpieScaling;
		private Krypton.Toolkit.KryptonNumericUpDown num_magpieDelay;
		private Krypton.Toolkit.KryptonButton btn_magpieExe;
		...
		private Krypton.Toolkit.KryptonCheckBox chk_patchGpuFix;
		//private Krypton.Toolkit.KryptonCheckBox chk_patchGpuTPB;
		private Krypton.Toolkit.KryptonCheckBox chk_patchReshade;
		...
		private Krypton.Toolkit.KryptonCheckBox chk_patchGpuTP;
		private Krypton.Toolkit.KryptonLabel kryptonLabel71;
		private Krypton.Toolkit.KryptonCheckBox chk_patchDisplayModeTP;
		private Krypton.Toolkit.KryptonCheckBox chk_patchDisplayModeFix;
		...
		private Krypton.Toolkit.KryptonLabel kryptonLabel77;
