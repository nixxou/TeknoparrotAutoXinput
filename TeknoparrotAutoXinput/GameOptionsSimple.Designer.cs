...
{
	partial class GameOptionsSimple
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel1.Controls.Add(tabInfo, 0, 1);
			tableLayoutPanel1.Controls.Add(lbl_Titre, 0, 0);
			...
			tableLayoutPanel1.Size = new Size(641, 513);
			tableLayoutPanel1.TabIndex = 0;
			// 
			// tabInfo
			// 
			tabInfo.Controls.Add(tabGeneral);
			tabInfo.Controls.Add(tabGamepad);
			tabInfo.Controls.Add(tabWheel);
			tabInfo.Controls.Add(tabHotas);
			tabInfo.Controls.Add(tabLightgun);
			tabInfo.Controls.Add(tabConfig);
			tabInfo.Dock = DockStyle.Fill;
			tabInfo.Location = new Point(3, 43);
			tabInfo.Name = "tabInfo";
			tabInfo.SelectedIndex = 0;
			tabInfo.Size = new Size(635, 428);
			tabInfo.TabIndex = 74;
			// 
			// tabGeneral
			// 
			...
			tabGeneral.Controls.Add(kryptonLabel18);
			tabGeneral.Controls.Add(kryptonLabel17);
			tabGeneral.Controls.Add(cmb_performance);
			tabGeneral.Controls.Add(cmb_useCrt);
			tabGeneral.Controls.Add(kryptonLabel7);
			tabGeneral.Controls.Add(cmb_useBezel);
			tabGeneral.Controls.Add(kryptonLabel6);
			tabGeneral.Controls.Add(panel4);
			tabGeneral.Controls.Add(grp_linkExe);
			tabGeneral.Controls.Add(grp_link);
			tabGeneral.Controls.Add(cmb_resolution);
			tabGeneral.Controls.Add(chk_group_monitorDisposition);
			tabGeneral.Controls.Add(kryptonLabel60);
			tabGeneral.Controls.Add(cmb_displayMode);
			tabGeneral.Controls.Add(kryptonLabel53);
			tabGeneral.Controls.Add(kryptonLabel40);
			tabGeneral.Controls.Add(cmb_patchReshade);
			tabGeneral.Controls.Add(cmb_patchFFB);
			tabGeneral.Controls.Add(grp_monitorDisposition);
			tabGeneral.Controls.Add(kryptonLabel39);
			tabGeneral.Controls.Add(chk_runRivaTuner);
			tabGeneral.Location = new Point(4, 24);
			tabGeneral.Name = "tabGeneral";
			tabGeneral.Size = new Size(627, 400);
			...
			groupBox3.Controls.Add(chk_overrideTpController);
			groupBox3.Controls.Add(chk_useThirdParty);
			groupBox3.Controls.Add(chk_overrideTpGameSettings);
			groupBox3.Controls.Add(chk_applyPatches);
			groupBox3.Location = new Point(3, 3);
			groupBox3.Name = "groupBox3";
			groupBox3.Size = new Size(309, 91);
			groupBox3.TabIndex = 240;
			groupBox3.TabStop = false;
			groupBox3.Text = "Options Principales";
			// 
			// chk_overrideTpController
			// 
			chk_overrideTpController.LabelStyle = Krypton.Toolkit.LabelStyle.BoldControl;
			chk_overrideTpController.Location = new Point(6, 16);
			chk_overrideTpController.Name = "chk_overrideTpController";
			chk_overrideTpController.Size = new Size(249, 20);
			chk_overrideTpController.TabIndex = 236;
			...
			cmb_patchlang.Location = new Point(138, 226);
			...
			cmb_forcevsync.Location = new Point(138, 200);
			cmb_forcevsync.Name = "cmb_forcevsync";
			cmb_forcevsync.Size = new Size(169, 21);
			cmb_forcevsync.StateCommon.ComboBox.Content.TextH = Krypton.Toolkit.PaletteRelativeAlign.Near;
			cmb_forcevsync.TabIndex = 230;
			// 
			// kryptonLabel18
			// 
			kryptonLabel18.Location = new Point(10, 201);
			kryptonLabel18.Name = "kryptonLabel18";
			kryptonLabel18.Size = new Size(81, 20);
			kryptonLabel18.TabIndex = 231;
			kryptonLabel18.Values.Text = "Force Vsync :";
			// 
			// kryptonLabel17
			// 
			kryptonLabel17.Location = new Point(10, 152);
			kryptonLabel17.Name = "kryptonLabel17";
			kryptonLabel17.Size = new Size(124, 20);
			kryptonLabel17.TabIndex = 229;
			kryptonLabel17.Values.Text = "Performance profile :";
			// 
			// cmb_performance
			// 
			...
			kryptonLabel7.Values.Text = "Use CRT Filter :";
			// 
			// cmb_useBezel
			// 
			...
			kryptonLabel6.Values.Text = "Use Bezel :";
			// 
			// panel4
			// 
			...
			panel4.Location = new Point(16, 279);
			panel4.Name = "panel4";
			...
			grp_linkExe.Location = new Point(16, 320);
			...
			grp_link.Location = new Point(16, 360);
			...
			cmb_displayMode.Location = new Point(138, 127);
			...
			cmb_displayMode.TabIndex = 203;
			// 
			// kryptonLabel53
			// 
			kryptonLabel53.Location = new Point(10, 128);
			kryptonLabel53.Name = "kryptonLabel53";
			kryptonLabel53.Size = new Size(91, 20);
			kryptonLabel53.TabIndex = 204;
			...
			grp_monitorDisposition.Location = new Point(318, 4);
			...
			// txt_monitorswitch
			// 
			txt_monitorswitch.Location = new Point(7, 37);
			txt_monitorswitch.Name = "txt_monitorswitch";
			txt_monitorswitch.ReadOnly = true;
			txt_monitorswitch.Size = new Size(185, 23);
			txt_monitorswitch.TabIndex = 44;
			// 
			// btn_editMonitorSwitch
			// 
			btn_editMonitorSwitch.Location = new Point(198, 36);
			...
			// kryptonLabel12
			// 
			kryptonLabel12.Location = new Point(7, 19);
			...
			// kryptonLabel39
			// 
			kryptonLabel39.Location = new Point(10, 176);
			kryptonLabel39.Name = "kryptonLabel39";
			kryptonLabel39.Size = new Size(59, 20);
			kryptonLabel39.TabIndex = 208;
			kryptonLabel39.Values.Text = "Use FFB :";
			// 
			// chk_runRivaTuner
			// 
			chk_runRivaTuner.Location = new Point(10, 253);
			...
			tabGamepad.Size = new Size(627, 400);
			...
			cmb_favorJoystick.Location = new Point(259, 156);
			...
			cmb_favorJoystick.TabIndex = 110;
			// 
			// kryptonLabel46
			// 
			kryptonLabel46.Location = new Point(10, 156);
			kryptonLabel46.Name = "kryptonLabel46";
			kryptonLabel46.Size = new Size(252, 20);
			kryptonLabel46.TabIndex = 109;
			...
			tabWheel.Size = new Size(627, 400);
			tabWheel.TabIndex = 1;
			...
			chk_enableGearChange.Location = new Point(26, 172);
			...
			tabHotas.Size = new Size(627, 400);
			tabHotas.TabIndex = 2;
			...
			tabLightgun.Size = new Size(627, 400);
			...
			groupBox5.Controls.Add(groupCrosshair);
			groupBox5.Location = new Point(3, 3);
			groupBox5.Name = "groupBox5";
			groupBox5.Size = new Size(603, 378);
			...
			groupBox12.Location = new Point(329, 22);
			groupBox12.Name = "groupBox12";
			groupBox12.Size = new Size(256, 188);
			...
			// kryptonLabel37
			// 
			kryptonLabel37.Location = new Point(2, 152);
			...
			cmb_gunB_sindenRecoil3.Location = new Point(200, 152);
			...
			cmb_gunB_sindenRecoil2.Location = new Point(149, 152);
			...
			cmb_gunB_sindenRecoil1.Location = new Point(98, 152);
			...
			cmb_gunB_OffscreenReload.Location = new Point(98, 71);
			...
			// kryptonLabel20
			// 
			kryptonLabel20.Location = new Point(1, 72);
			...
			cmb_gunB_UseVjoy.Location = new Point(98, 98);
			...
			// kryptonLabel16
			// 
			kryptonLabel16.Location = new Point(1, 99);
			...
			cmb_gunB_Crosshair.Location = new Point(98, 43);
			...
			cmb_gunB_sindenPump.Location = new Point(98, 126);
			...
			// kryptonLabel13
			// 
			kryptonLabel13.Location = new Point(1, 44);
			...
			// kryptonLabel14
			// 
			kryptonLabel14.Location = new Point(0, 127);
			...
			groupBox11.Location = new Point(8, 22);
			groupBox11.Name = "groupBox11";
			groupBox11.Size = new Size(255, 188);
			...
			// kryptonLabel32
			// 
			kryptonLabel32.Location = new Point(2, 152);
			...
			cmb_gunA_sindenRecoil3.Location = new Point(199, 151);
			...
			cmb_gunA_sindenRecoil2.Location = new Point(148, 151);
			...
			cmb_gunA_sindenRecoil1.Location = new Point(97, 151);
			...
			cmb_gunA_OffscreenReload.Location = new Point(97, 70);
			...
			// kryptonLabel19
			// 
			kryptonLabel19.Location = new Point(0, 71);
			...
			cmb_gunA_UseVjoy.Location = new Point(97, 97);
			...
			// kryptonLabel15
			// 
			kryptonLabel15.Location = new Point(0, 98);
			...
			cmb_gunA_Crosshair.Location = new Point(97, 42);
			...
			cmb_gunA_sindenPump.Location = new Point(97, 124);
			...
			// kryptonLabel3
			// 
			kryptonLabel3.Location = new Point(0, 43);
			...
			// kryptonLabel29
			// 
			kryptonLabel29.Location = new Point(-1, 125);
			...
			lbl_Titre.Location = new Point(251, 5);
			lbl_Titre.Name = "lbl_Titre";
			lbl_Titre.Size = new Size(138, 29);
			lbl_Titre.TabIndex = 73;
			...
			panel1.Location = new Point(436, 479);
			panel1.Name = "panel1";
			panel1.Size = new Size(202, 29);
			panel1.TabIndex = 75;
			// 
			// btn_Save
			// 
			btn_Save.Location = new Point(103, 1);
			...
			// btn_Cancel
			// 
			btn_Cancel.Location = new Point(9, 1);
			...
			ClientSize = new Size(641, 513);
			Controls.Add(tableLayoutPanel1);
			Name = "GameOptionsSimple";
			Text = "GameOptionsSimple";
			Load += GameOptionsSimple_Load;
