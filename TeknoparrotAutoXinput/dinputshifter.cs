...
{
	public partial class dinputshifter : KryptonForm
	{
		...
		private void SaveConfig()
		{
			...
			IsConfigured = true;
			if (txt_InputDeviceGear1.Text == "") IsConfigured = false;
		...
		private void dinputshifter_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (_stopListening == false && threadJoystick != null)
			{
				_stopListening = true;
