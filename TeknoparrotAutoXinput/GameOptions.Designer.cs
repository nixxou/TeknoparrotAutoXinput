namespace TeknoparrotAutoXinput
{
	partial class GameOptions
	{
		...
		private void InitializeComponent()
		{
			...
			groupBox2.Location = new Point(19, 741);
			...
			groupBox1.Location = new Point(568, 741);
			...
			grp_monitorDisposition.Location = new Point(12, 96);
			grp_monitorDisposition.Name = "grp_monitorDisposition";
			grp_monitorDisposition.Size = new Size(538, 64);
			...
			chk_group_monitorDisposition.Location = new Point(420, 80);
			...
			// txt_ahkbefore
			// 
			txt_ahkbefore.Location = new Point(19, 197);
			...
			// txt_ahkafter
			// 
			txt_ahkafter.Location = new Point(568, 197);
			...
			// kryptonLabel1
			// 
			kryptonLabel1.Location = new Point(19, 171);
			...
			// kryptonLabel2
			// 
			kryptonLabel2.Location = new Point(568, 171);
			...
			grp_link.Location = new Point(573, 68);
			grp_link.Name = "grp_link";
			grp_link.Size = new Size(531, 92);
			grp_link.TabIndex = 54;
			grp_link.TabStop = false;
			grp_link.Text = "Links Files before Execute";
			// 
			// btn_link_open
			// 
			btn_link_open.Location = new Point(411, 34);
			btn_link_open.Name = "btn_link_open";
			btn_link_open.Size = new Size(105, 47);
			...
			lbl_LinkTo.Size = new Size(63, 20);
			lbl_LinkTo.TabIndex = 2;
			lbl_LinkTo.Values.Text = "To : XXXX";
			// 
			// lbl_linkFrom
			// 
			lbl_linkFrom.Location = new Point(13, 47);
			lbl_linkFrom.Name = "lbl_linkFrom";
			lbl_linkFrom.Size = new Size(168, 20);
			lbl_linkFrom.TabIndex = 1;
			lbl_linkFrom.Values.Text = "Link files from folder : XXXXX";
			// 
			// chk_linkfiles
			// 
			...
			// btn_Save
			// 
			btn_Save.Location = new Point(1009, 904);
			...
			// btn_Cancel
			// 
			btn_Cancel.Location = new Point(913, 904);
			...
			// chk_runAsAdmin
			// 
			chk_runAsAdmin.Location = new Point(18, 57);
