namespace TeknoparrotAutoXinput
{
	partial class dinputwheel
	{
		...
		private void InitializeComponent()
		{
			...
			cmb_devicelist.Location = new Point(699, 12);
			...
			label2.Location = new Point(52, 414);
			label2.Name = "label2";
			...
			label3.Location = new Point(58, 443);
			label3.Name = "label3";
			...
			label4.Location = new Point(55, 472);
			label4.Name = "label4";
			...
			label6.Location = new Point(357, 51);
			label6.Name = "label6";
			...
			label8.Location = new Point(486, 137);
			label8.Name = "label8";
			...
			label9.Location = new Point(711, 388);
			label9.Name = "label9";
			...
			label10.Location = new Point(470, 428);
			...
			label11.Location = new Point(340, 561);
