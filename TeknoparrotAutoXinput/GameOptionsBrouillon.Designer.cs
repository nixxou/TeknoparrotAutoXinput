...
{
	partial class GameOptionsBrouillon
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			tabControl1.Size = new Size(622, 425);
			tabControl1.TabIndex = 71;
			// 
			// tabGeneral
			// 
			tabGeneral.Controls.Add(btn_linkTarget_openExe);
			tabGeneral.Controls.Add(cmb_resolution);
			tabGeneral.Controls.Add(txt_linkToExe);
			tabGeneral.Controls.Add(kryptonLabel60);
			tabGeneral.Controls.Add(txt_linkFromExe);
			tabGeneral.Controls.Add(cmb_displayMode);
			tabGeneral.Controls.Add(btn_link_openExe);
			tabGeneral.Controls.Add(kryptonLabel53);
			tabGeneral.Controls.Add(txt_linkFrom);
			tabGeneral.Controls.Add(kryptonLabel40);
			tabGeneral.Controls.Add(btn_link_open);
			...
			tabGeneral.Size = new Size(614, 397);
			...
			// 
			btn_linkTarget_openExe.Location = new Point(458, 317);
			...
			cmb_resolution.Location = new Point(118, 23);
			...
			// txt_linkToExe
			// 
			txt_linkToExe.Location = new Point(24, 317);
			...
			// kryptonLabel60
			// 
			kryptonLabel60.Location = new Point(17, 24);
			...
			// txt_linkFromExe
			// 
			txt_linkFromExe.Location = new Point(24, 288);
			...
			cmb_displayMode.Location = new Point(117, 50);
			...
			// btn_link_openExe
			// 
			btn_link_openExe.Location = new Point(458, 288);
			...
			// kryptonLabel53
			// 
			kryptonLabel53.Location = new Point(18, 51);
			...
			// txt_linkFrom
			// 
			txt_linkFrom.Location = new Point(26, 259);
			...
			// kryptonLabel40
			// 
			kryptonLabel40.Location = new Point(17, 84);
			...
			// btn_link_open
			// 
			btn_link_open.Location = new Point(412, 259);
			...
			cmb_patchReshade.Location = new Point(148, 77);
			...
			chk_group_monitorDisposition.Location = new Point(467, 176);
			...
			cmb_patchFFB.Location = new Point(148, 110);
			...
			grp_monitorDisposition.Location = new Point(17, 190);
			...
			// kryptonLabel39
			// 
			kryptonLabel39.Location = new Point(18, 111);
			...
			// chk_runRivaTuner
			// 
			chk_runRivaTuner.Location = new Point(18, 153);
			...
			tabGamepad.Size = new Size(614, 397);
			...
			tabWheel.Size = new Size(614, 397);
			tabWheel.TabIndex = 1;
			...
			chk_enableGearChange.Location = new Point(23, 169);
			...
			tabHotas.Size = new Size(614, 397);
			tabHotas.TabIndex = 2;
			...
			tabLightgun.Size = new Size(614, 397);
			...
			groupBox5.Size = new Size(599, 379);
			...
			cmb_gunB_sindenPump.Location = new Point(97, 42);
			...
			// kryptonLabel14
			// 
			kryptonLabel14.Location = new Point(-1, 43);
			...
			groupCrosshair.Location = new Point(8, 250);
			...
			Name = "GameOptionsBrouillon";
			Text = "GameOptionsBrouillon";
			Load += GameOptionsBrouillon_Load;
